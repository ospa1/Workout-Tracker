...
<body>
	...
	<div class="container d-flex justify-content-center" id="set">
		<form class="form-inline" id="form" method="POST" style="margin-top: 40px">
			...
			<input type="number" class="form-control mb-2 mr-sm-2" id="weight" name="weight" placeholder="Lbs"></input>
			<input type="number" class="form-control mb-2 mr-sm-2" id="reps" name="reps" placeholder="Reps"></input>
